...
interface AlterCompanyEmailTemplateProps {
    name: string
    previewText: string
    url: string
    companyId: string
...
export function AlterCompanyEmailTemplate({ name, previewText, url, companyId }: AlterCompanyEmailTemplateProps) {
  return (
      <Html>
        <Head>
            <meta charSet="UTF-8" />
          ...
          <Body className="bg-white my-auto mx-auto font-sans">
            ...
            <Container className="mx-auto">
              ...
              <Text className="mt-4 text-base text-gray-text text-center">
                Uma nova companhia foi adicionada ao seu usuário
              </Text>
            </Container>
